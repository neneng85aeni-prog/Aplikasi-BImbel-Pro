  ...
  return (
    <main className="app-shell">
      ...
      <section className="content-area">
        ...
        {activeTab === 'jadwal_guru' && (
  <JadwalGuruTab 
    users={state.usersTampil}
    jadwalGuru={state.jadwalGuruTampil} // Pastikan state ini sudah di-fetch dari Supabase
    onSubmitJadwal={actions.submitJadwalGuru}
    onDeleteJadwal={actions.deleteJadwalGuru}
  />
)}
