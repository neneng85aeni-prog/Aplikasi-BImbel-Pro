  ...
  return (
    <div className="grid grid-2">
      ...
      <div className="glass-card">
        ...
        <div className="btn-row"><button className="btn btn-primary" type="button" onClick={onSubmitKasir}>Simpan transaksi</button><button className="btn btn-secondary" type="button" onClick={() => onPrintReceipt()}>Print struk terakhir</button></div>
