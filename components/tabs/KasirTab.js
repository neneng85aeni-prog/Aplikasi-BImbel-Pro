      ...
      <div className="glass-card">
        ...
        <div className="grid grid-2">
          ...
          <div className="glass-card" style={{ padding: '20px' }}>
            ...
            {/* CSS Putih Dihapus, Pakai Transparent */}
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999 }}>
          <div className="glass-card" style={{ width: '100%', maxWidth: '400px', padding: '30px', textAlign: 'center', border: '1px solid rgba(255,255,255,0.2)' }}>
            ...
            <div style={{ background: 'rgba(0,0,0,0.3)', padding: '15px', borderRadius: '12px', textAlign: 'left', marginBottom: '25px', fontSize: '13px', border: '1px solid rgba(255,255,255,0.05)' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px' }}><span className="text-muted">Nominal:</span> <b>{formatRupiah(lastReceipt.nominal)}</b></div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px' }}><span className="text-muted">Metode:</span> <b>{lastReceipt.metode_bayar.toUpperCase()}</b></div>
