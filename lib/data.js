...
export async function upsertUserViaRpc(form, id) {
  return supabase.rpc('app_upsert_user', {
    ...
    p_akses: form.akses !== undefined ? form.akses : null, // <-- Dikembalikan ke asli agar tidak error
    p_branch_id: form.branch_id ? form.branch_id : null,   // <-- Hanya ID ini yang dijaga ketat
    ...
    p_batas_jam_masuk: form.batas_jam_masuk || null,
    p_batas_jam_pulang: form.batas_jam_pulang || null
  })
}
