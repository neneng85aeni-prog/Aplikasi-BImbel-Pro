...
export async function upsertUserViaRpc(form, id) {
  return supabase.rpc('app_upsert_user', {
    ...
    p_salary_fixed: form.salary_fixed,
    p_student_fee_daily: form.student_fee_daily,
    p_monthly_bonus_target: form.monthly_bonus_target,
    p_bonus_amount: form.bonus_amount,
