...
export const INITIAL_USER_FORM = { id: '', nama: '', email: '', password: '', akses: 'guru', branch_id: '', no_telepon: '', salary_type: 'fixed', salary_fixed: '', student_fee_daily: '', monthly_bonus_target: '', bonus_amount: '', menu_permissions: [] }
...
export const INITIAL_KASIR_FORM = { status: 'lunas', nominal: '', keterangan: '', metode_bayar: 'cash', program_id: '' }
...
export function defaultPermissionsByRole(akses) {
  const map = {
    ...
    admin: ['overview', 'program', 'users', 'permissions', 'siswa', 'kasir', 'perkembangan', 'karyawan', 'review', 'pengeluaran', 'laporan', 'payroll', 'download'],
    guru: ['overview', 'siswa', 'perkembangan', 'karyawan', 'laporan', 'download'],
    kasir: ['overview', 'kasir', 'karyawan', 'pengeluaran', 'laporan', 'download'],
...
// LOGIKA BARU: Apa yang dicentang, itu yang muncul (Mengabaikan default jika sudah diubah)
