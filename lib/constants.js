...
export function defaultPermissionsByRole(akses) {
  ...
  const map = {
    ...
    // Kita tambahkan 'jadwal' di admin dan guru sesuai rencana tadi
    admin: ['overview', 'jadwal', 'program', 'users', 'permissions', 'siswa', 'kasir', 'perkembangan', 'karyawan', 'review', 'inventory', 'pengeluaran', 'laporan', 'payroll', 'download'],
    guru: ['overview', 'jadwal', 'siswa', 'perkembangan', 'karyawan', 'laporan', 'download'],
