...
// === KONSTANTA BARU UNTUK JADWAL ===
export const DAYS_OPTIONS = ['Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu', 'Minggu']

// Template data ketersediaan (untuk dicentang di form guru)
...
// Tambahkan ke INITIAL_USER_FORM agar saat tambah guru baru, datanya sudah siap
export const INITIAL_USER_FORM = { 
  // ... (kode lama Mas Hamzah) ...
  akses: 'GURU',
  // TAMBAHAN BARU:
  availability: INITIAL_AVAILABILITY, 
  programs_can_handle: [] // Menampung ID program yang dikuasai
}

// Template untuk Jadwal Tetap Siswa (saat daftar)
