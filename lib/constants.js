...
// DITAMBAHKAN jenis_transaksi DAN inventory_id
export const INITIAL_KASIR_FORM = { status: 'lunas', nominal: '', keterangan: '', metode_bayar: 'cash', program_id: '', jenis_transaksi: 'program', inventory_id: '' }
