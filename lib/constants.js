...
/* BAGIAN INI YANG DIUBAH: akses: '' (kosong) */
export const INITIAL_USER_FORM = { id: '', nama: '', email: '', password: '', akses: '', branch_id: '', no_telepon: '', salary_type: 'fixed', salary_fixed: '', student_fee_daily: '', monthly_bonus_target: '', bonus_amount: '', menu_permissions: [] }
...
export const INITIAL_KASIR_FORM = { status: 'lunas', nominal: '', diskon: '', keterangan: '', metode_bayar: 'cash', program_id: '', jenis_transaksi: 'program', inventory_id: '' }
